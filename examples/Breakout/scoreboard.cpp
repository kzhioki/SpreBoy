...
class Scoreboard {
  ...
  public:
    ...
    void init()
    {
      ...
      drawString("     000000000    0",       0, 4, 2, BLACK);
      drawString("   S            L    B",   6, 4, 2, BLUE);
      drawString("              0    1   4",  0, 4, 2, RED);
    }
  
    void update( int scored ){
      score+= scored;
      int digits = nDigits(score);
      drawNumber(score, (15-digits)*12, 4, 2, RED, SCOREBOARD_COLOR);
    }
    ...
    void nextLevel()
    {
      ...
      drawNumber(level,(20-digits)*12, 4, 2, RED, SCOREBOARD_COLOR);
    }
    ...
    void died()
    {
      ...
      drawNumber(lives,(24-digits)*12, 4, 2, RED, SCOREBOARD_COLOR);
    }
